...
# # Create a dataset for TROPOMI netCDF4 file // Nice way
# test_file = '/export/data/scratch/tropomi/no2/S5P_OFFL_L2__NO2____20200505T070610_20200505T084741_13264_01_010302_20200507T000819.nc'
...
#     fh = file
#     grp = 'PRODUCT'
#     lons = fh.groups[grp].variables['longitude'][:][0,:,:] # longitude
#     lats = fh.groups[grp].variables['latitude'][:][0,:,:] # latitude
#     # NO2 data from nitrogendioxide_tropospheric_column 
#     no2 = fh.groups[grp].variables['nitrogendioxide_tropospheric_column'][0,:,:]
#     print(lats)
#     file.close()
...
for test_file in fileList:
    ...
    if(user_input == 'N' or user_input == 'n'):
        ...
        cs = m.pcolor(xi,yi,np.squeeze(data),norm=LogNorm(vmin=10e-11, vmax=10e-3), cmap='jet')
        ...
        if is_save == 'Y' or is_save == 'y':
            ...
            pngfile = '{0}.png'.format(short_file_name[:-3])
